                ...
                <tbody>
                    <tr>
                       <?php
                        ...
                        $dt_jumlah = mysqli_query($koneksi, "SELECT *, SUM(JumlahProduk) as JumlahProduk from tb_detail_penjualan INNER JOIN tb_produk ON tb_produk.ProdukID = tb_detail_penjualan.ProdukID where PenjualanID = '$kodeBarang' GROUP BY tb_detail_penjualan.ProdukID");
                       $no=1;
